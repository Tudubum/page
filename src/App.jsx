...
import NavBar from './components/NavBar';
  ...
  const [arAplankyta, setArAplankyta] = useState('false');
    ...
    const addPlace = async (newSeries) => { //newSeries komponentas yra naujo serijalo duomenys, kurios norime itraukti i serveri 
  ...
  const editPlace = async (id, updatedSeries ) => {
    await fetch(`http://localhost:7000/Restingplace/${id}`, {
      method: 'PUT',
